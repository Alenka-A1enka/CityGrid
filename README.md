В репозитории расположены папки для каждого задания из 5, итоговая программа находится в папке Task4-5, однако остальные папки отражают процесс разработки более итеративно. 
